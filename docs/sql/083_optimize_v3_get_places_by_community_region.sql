-- =====================================================
-- 083_optimize_v3_get_places_by_community_region.sql
-- v2_get_places_by_community_region 최적화 버전
-- 
-- 개선 사항:
...
--   @p_domain: 커뮤니티 도메인 (옵션)
--   @p_limit: 조회할 개수 (기본 20)
--   @p_offset: 오프셋 (기본 0)
-- 
-- 실행 방법:
--   psql "postgresql://postgres.xyqpggpilgcdsawuvpzn:ZNDqDunnaydr0aFQ@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres" -f docs/sql/083_optimize_v3_get_places_by_community_region.sql
-- =====================================================
...
COMMENT ON FUNCTION public.v3_get_places_by_community_region IS '커뮤니티 지역 장소 조회 v3 - 최적화 버전 (N+1 제거, 배치 처리)';
GRANT EXECUTE ON FUNCTION public.v3_get_places_by_community_region TO authenticated, anon;
