-- =====================================================
-- 099_update_v1_list_my_folders_add_thumbnail.sql
-- v1_list_my_folders에 최근 저장된 음식점(place) 썸네일 1개 URL 추가
-- 
-- 인자:
--   p_place_id: 특정 장소 ID (포함 여부 확인용)
-- 
-- 반환 컬럼 추가:
--   thumbnail_url: 최근 저장된 place의 images[1] 또는 place_images[1], 없으면 NULL
-- 
-- 실행 방법:
--   psql "postgresql://postgres.xyqpggpilgcdsawuvpzn:ZNDqDunnaydr0aFQ@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres" -f docs/sql/099_update_v1_list_my_folders_add_thumbnail.sql
-- =====================================================
