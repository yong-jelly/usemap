-- =====================================================
-- 050_revert_memo_sync.sql
-- 폴더별 독립적인 메모 관리로 복구 (메모 동기화 및 자동 연동 제거)
-- 
-- 실행 방법:
--   psql "postgresql://postgres.xyqpggpilgcdsawuvpzn:ZNDqDunnaydr0aFQ@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres" -f docs/sql/050_revert_memo_sync.sql
-- =====================================================

-- 1. v1_add_place_to_folder 함수 업데이트 (독립적인 메모 관리)
...
COMMENT ON FUNCTION public.v1_add_place_to_folder IS '폴더에 장소 추가 및 폴더별 독립적인 메모 관리';
