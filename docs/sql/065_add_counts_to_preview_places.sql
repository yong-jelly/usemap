-- =====================================================
-- 065_add_counts_to_preview_places.sql
-- 프리뷰 장소 목록(preview_places, preview_contents)에 좋아요 수 및 리뷰 수 추가
-- 
-- 실행 방법:
--   psql "postgresql://postgres.xyqpggpilgcdsawuvpzn:ZNDqDunnaydr0aFQ@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres" -f docs/sql/065_add_counts_to_preview_places.sql
-- =====================================================
