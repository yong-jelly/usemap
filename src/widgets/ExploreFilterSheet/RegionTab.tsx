    ...
    <div className="space-y-6">
      ...
      {!hasUserLocation && (
        <LocationGuideBox 
          ...
          buttonText="위치 설정하기"
          showButton={true}
          onButtonClick={onLocationSettingClick}
        />
      )}
      ...
      <div className={cn(
        "flex -mx-6 overflow-hidden border-t-2 border-surface-100 dark:border-surface-800",
        hasUserLocation ? "h-[50vh]" : "h-[40vh]"
      )}>
        {/* Sidebar: 시/도 (group1) */}
